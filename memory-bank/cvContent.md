# CV Content (verbatim from `CV Resume.pdf`, extracted 2026-09-20)

Source of truth for all site copy. Do not paraphrase into the site without checking here. Do not add facts not in this file.
...
### Data Analytics Consultant — NovaDSA
...
### SAP BW Consultant — NTT DATA Business Solutions, BSH Data Analytics
...
### Data Analytics Project Student — Bosch & Siemens Home Appliances (BSH)
...
- SAP Analytics Cloud
- SQL
- Python & Data Analytics Libraries (eg. Numpy, Pandas, PySpark)
- Data Analytics & Engineering Related AWS Services: Redshift, SageMaker, QuickSight, Glue, Athena, S3

## Education
- **Istanbul Technical University** — Industrial Engineering, 2019–2023, GPA: 3.63 out of 4
- **Koc High School** — 2014–2019

## Languages
- Turkish — Native
- English — Advanced (TOEFL IBT Score: 98)
- Spanish — Beginner
